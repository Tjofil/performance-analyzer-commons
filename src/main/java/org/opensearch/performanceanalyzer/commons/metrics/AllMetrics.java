 ...
 * org.opensearch.performanceanalyzer.commons.collectors), while reader creates db tables using
 * these keys as column names and extract values using these keys. You should make sure the field
 * names in the MetricStatus's subclasses and enum names match. Also, when you change anything,
 * modify JsonKeyTest accordingly. We use camelCase instead of the usual capital case for enum
 * members because they have better readability for the above use cases.
 */
